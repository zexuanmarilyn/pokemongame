...
print(type(comp_gen_num))

#question - how to prevent first part of code from rerunning again?5
...
user_number_choice2=int(input("Pick a number:"))
if user_number_choice2==comp_gen_num:
     message="Congratulations, you have won"
elif user_number_choice2<comp_gen_num:
    message="Number chosen is lower than actual"
else:
    message="Number chosen is higher than actual"
print(message)

user_number_choice3=int(input("Pick a number:"))
if user_number_choice3==comp_gen_num:
     message="Congratulations, you have won"
elif user_number_choice3<comp_gen_num:
    message="Number chosen is lower than actual"
else:
    message="Number chosen is higher than actual"
print(message)
